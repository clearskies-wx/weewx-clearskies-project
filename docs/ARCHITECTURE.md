...
| **8767** | TCP | SWAN standalone service (target — replaced by marine service on port 8780, pending ADR-099 acceptance) | `librewxr` | `0.0.0.0` | Currently-running `weewx-clearskies-swan` service. Eliminated when the unified marine service is deployed. |
