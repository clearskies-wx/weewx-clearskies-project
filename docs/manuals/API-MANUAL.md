...
| `power` | int | Swell Power (0–100). Dominant `multiSwell` partition period table (0.7) + dominant partition's SHARE of total partition energy, bucketed (0.3). Never Tm01. `multiSwell` null → 0.5 neutral (logged). |
