...
| D1 | As-built doc re-sync + zero-drift audit (the predecessor's DOC-W-FINAL) | 🔄 **IN PROGRESS 2026-08-27** — docs-author dispatched (brief `docs/planning/briefs/D1-AS-BUILT-DOCS-BRIEF-2026-08-27.md`; pinned: marine `6c9dc15`, API `811fe88`, dashboard `b307797`, stack `d3d8bec`); firewalled zero-drift auditor follows on `scratch/GATE-D1-DEFINITION.md` (X1–X13). No ADR status flips (all four amendments stay Proposed until the operator accepts) |
