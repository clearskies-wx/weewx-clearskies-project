...
| R4a–R4d | **Code complete** — marine `1cd1209` restores level-specific current-file dimensions and truthful current evidence | Complete — no document delta; restores existing contract | Post-code independent source review passes; live QC pending | Prior candidate `eff77fc` remains deployed; `1cd1209` not yet deployed | Obtain the required live WCOFS full/fast, source-clock, preflight, and hotstart-quarantine evidence. |
...
| R8b / R8c | **R8b code complete** — marine `1cd1209` restores truthful horizon/current/nested-level evidence; R8c open | Complete — no document delta; restores existing contract | R8b post-code independent source review passes; live QC pending | Prior candidate `eff77fc` remains deployed; `1cd1209` not yet deployed | Obtain live marine/API/operator-surface agreement for full, fast, restart, and named refusal states. |
