...
| E2 | API-MANUAL.md — station response | `docs/API-MANUAL.md` | Document new `archiveIntervalSeconds` field |
...
- Owner: Coordinator (Opus)
- Do: Commit and push `docs/ARCHITECTURE.md`, `docs/API-MANUAL.md`, `rules/coding.md`, `rules/clearskies-process.md`.
