...
**Components:** 4 new manuals (`docs/API-MANUAL.md`, `docs/PROVIDER-MANUAL.md`, `docs/OPERATIONS-MANUAL.md`, `docs/DASHBOARD-MANUAL.md`), ARCHITECTURE.md restructure, CLAUDE.md routing, process rule updates, registry system, 48 ADR archives
...
|---|--------|-----------------|---------------|-----------------|
| 1 | `docs/API-MANUAL.md` | `clearskies-api-dev` agent | 12 ADRs | ~800-1200 lines |
| 2 | `docs/PROVIDER-MANUAL.md` | `clearskies-api-dev` agent | 14 ADRs | ~600-900 lines |
| 3 | `docs/OPERATIONS-MANUAL.md` | ops work, `clearskies-auditor`, config UI dev | 13 ADRs + security-baseline.md | ~700-1000 lines |
| 4 | `docs/DASHBOARD-MANUAL.md` | `clearskies-dashboard-dev` agent | 7 ADRs | ~400-600 lines |
...
- Deliverable: Complete `docs/API-MANUAL.md`
- Accept when:
...
- Deliverable: Complete `docs/PROVIDER-MANUAL.md`
- Accept when:
...
- Deliverable: Complete `docs/OPERATIONS-MANUAL.md`
- Accept when:
  - [ ] All 12 sections present
...
- Deliverable: Complete `docs/DASHBOARD-MANUAL.md`
- Accept when:
...
- New routing rows:
  - API development, data model, units, enrichment → `docs/API-MANUAL.md`
  - Provider modules, caching, external APIs → `docs/PROVIDER-MANUAL.md`
  - Deployment, security, auth, monitoring, config → `docs/OPERATIONS-MANUAL.md`
  - Dashboard technical behavior, i18n, timezone, performance → `docs/DASHBOARD-MANUAL.md`
...
| Task involves... | Load |
|---|---|
| API development, data model, units, enrichment, DB access, SSE | `docs/API-MANUAL.md` + `docs/ARCHITECTURE.md` |
| Provider modules, external APIs, caching, compliance | `docs/PROVIDER-MANUAL.md` |
| Deployment, security, auth, monitoring, config, wizard | `docs/OPERATIONS-MANUAL.md` |
| Dashboard technical behavior, i18n, timezone, performance, data refresh | `docs/DASHBOARD-MANUAL.md` |
| UI design, visual patterns, tokens, component styling | `docs/DESIGN-MANUAL.md` |
...
**`clearskies-api-dev`:** "Before any code change, read `docs/API-MANUAL.md` and `docs/PROVIDER-MANUAL.md`. These are the single authority for API implementation rules."

**`clearskies-dashboard-dev`:** "Before any code change, read `docs/DESIGN-MANUAL.md` and `docs/DASHBOARD-MANUAL.md`. DESIGN-MANUAL covers visual rules; DASHBOARD-MANUAL covers technical behavior."
...
- Before modifying API code: read `docs/API-MANUAL.md`.
- Before modifying provider modules: read `docs/PROVIDER-MANUAL.md`.
- Before modifying deployment, config, or security: read `docs/OPERATIONS-MANUAL.md`.
- Before modifying dashboard technical behavior: read `docs/DASHBOARD-MANUAL.md`.
- Before modifying UI/visual code: read `docs/DESIGN-MANUAL.md` (existing rule, already in §9).
...
| Provider modules | `docs/PROVIDER-MANUAL.md` |
| Dashboard (technical) | `docs/DASHBOARD-MANUAL.md` |
| Dashboard (visual) | `docs/DESIGN-MANUAL.md` |
| Deployment / Security / Config | `docs/OPERATIONS-MANUAL.md` |
