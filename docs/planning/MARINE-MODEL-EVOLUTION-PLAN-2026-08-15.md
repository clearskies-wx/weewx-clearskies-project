...
| Gate DOC-W | Independent audit of the docs | 🔄 DISPATCHED 2026-08-17 — adversarial, results-free definition `scratch/GATE-DOCW-DEFINITION.md` (written before any round results existed) |
