...
| F2 | Configure WW3 for our waters (scratch only) | 🔄 IN PROGRESS (dispatched 2026-08-16 after Q5 ruling + 6.07 syntax re-verification applied; scope includes F1's aux-program gap — ww3_bound/bounc + ww3_prnc/prep rebuilt at the same 6.07.1 ref; brief `scratch/BRIEF-F2-CONFIG.md`) |
