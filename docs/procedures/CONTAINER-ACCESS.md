...
| Clear Skies front-end host (dashboard + config) | `weather-dev` | `ssh ratbert "lxc exec weather-dev -- bash"` | Dashboard SPA (static files), config UI (port 9876), Caddy (ports 80/443 — proxies to API on weewx) |
