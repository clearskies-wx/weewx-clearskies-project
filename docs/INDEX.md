...
- **[reference/SWAN-ENERGY-LOSS-RESEARCH-2026-08-15.md](reference/SWAN-ENERGY-LOSS-RESEARCH-2026-08-15.md)** — formal research brief (operator-ordered): manual- and literature-grounded evidence on the L1 march energy loss — depth-step/shelf-break error (R1/R2/R4), grid-architecture option set incl. CDIP/MOP precomputed-transfer precedent (R3), DIFFRAC applicability + island-shadow refill (R5). All manual cites coordinator-verified; findings only, no chosen design — operator rules.
