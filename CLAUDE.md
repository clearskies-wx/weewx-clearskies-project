...
| **SWAN wave model** — commands, spectral/spatial/directional resolution, diffraction, refraction, obstacles, numerics, convergence, physics | **[docs/reference/swan-user-manual.txt](docs/reference/swan-user-manual.txt) — the FULL official SWAN User Manual is IN THE PROJECT** + [docs/reference/swan-commands-extract.md](docs/reference/swan-commands-extract.md) (our per-level command usage). **ALWAYS consult these local files for any SWAN question. DO NOT web-search SWAN behavior — the manual is right here.** (e.g. §2.6.3 spectral resolution: swell needs 5°–2° directional, wind sea 10°–15°.) |
